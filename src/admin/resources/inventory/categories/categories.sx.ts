// src/admin/resources/inventory/categories/categories.sx.ts
import { colors, radius, shadows, space, typography } from '../../../../design/tokens';

/**
 * ✅ Categories com estilos próprios (sem depender de exports globais).
 * Regras do app:
 ...
 */
export const categoryDatagridSx = {
  width: '100%',
  overflow: 'visible',
  background: 'transparent',
  boxShadow: 'none',
 ...
 */
export const categoryDetailsSx = {
 ...
 */
export const categorySearchWrapSx = {
 ...
 * HEADER PILL BUTTONS
 */
export const categoryPillBtnSx = {
 ...
 * BUTTONS (base)
 */
export const categoryPrimaryBtnSx = {
...
export const categoryGhostBtnSx = {
  borderRadius: radius.button, // ✅ permitido (botão)
  minHeight: 40,
  px: `${space[4]}px`,
  fontWeight: 800,
 ...
 * ROW ACTION ICONS
 */
export const categoryActionIconSx = {
  width: 40,
  height: 40,
...
export const categoryDangerIconSx = {
  ...categoryActionIconSx,
  borderColor: `rgba(255, 66, 66, 0.35)`,
  '&:hover': {
    ...categoryActionIconSx['&:hover'],
 ...
 */
export const erpListSx = categoryListSx;
export const erpDatagridSx = categoryDatagridSx;
export const erpDetailsSx = categoryDetailsSx;
export const erpFormSx = categoryFormSx;
