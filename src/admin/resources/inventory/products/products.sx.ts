// src/admin/resources/inventory/products/products.sx.ts
import { colors, radius, shadows, space, typography } from '../../../../design/tokens';

/**
 * ✅ Products com estilos próprios (sem depender de exports globais).
 * Regras do app:
 ...
 */
export const productDatagridSx = {
  width: '100%',
  overflow: 'visible',
  background: 'transparent',
  boxShadow: 'none',
 ...
 */
export const productSearchWrapSx = {
 ...
 * BUTTONS (base)
 */
export const productPrimaryBtnSx = {
...
export const productGhostBtnSx = {
  borderRadius: radius.button, // ✅ permitido (botão)
  minHeight: 40,
  px: `${space[4]}px`,
  fontWeight: 800,
 ...
 * ROW ACTION ICONS
 */
export const productActionIconSx = {
  width: 40,
  height: 40,
...
export const productDangerIconSx = {
  ...productActionIconSx,
  borderColor: `rgba(255, 66, 66, 0.35)`,
  '&:hover': {
    ...productActionIconSx['&:hover'],
 ...
 */
export const erpListSx = productListSx;
export const erpDatagridSx = productDatagridSx;
export const erpDetailsSx = productDetailsSx;
export const erpFormSx = productFormSx;
