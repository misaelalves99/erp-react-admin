// src/admin/resources/fiscal/fiscalDocuments/fiscalDocuments.sx.ts
import { colors, radius, shadows, space, typography } from '../../../../design/tokens';

/**
 * ✅ FiscalDocuments com estilos próprios (sem depender de exports globais do layout).
 * Regras do app:
 ...
 * LIST (ListPage)
 */
export const fiscalDocumentListSx = {
  '& .RaList-main': {
    width: '100%',
    minWidth: 0,
    paddingTop: 0,
  ...
  // ✅ alguns fluxos renderizam Paper/Card por baixo
  '& .MuiPaper-root': {
    borderRadius: 0,
  },
} as const;
...
/**
 * DATAGRID (List)
 * - Radius só no wrapper da tabela (padrão que você pediu)
 */
export const fiscalDocumentDatagridSx = {
  width: '100%',
  overflow: 'visible',
  background: 'transparent',
  boxShadow: 'none',
 ...
 */
export const fiscalDocumentDetailsSx = {
 ...
 */
export const fiscalDocumentFormSx = {
  borderRadius: 0,
  background: 'transparent',
  boxShadow: 'none',
  border: 'none',
 ...
 * SEARCH (Filter)
 */
export const fiscalDocumentSearchWrapSx = {
 ...
 * HEADER “PILL BUTTONS”
 */
export const fiscalDocumentPillBtnSx = {
 ...
 * BUTTONS (base)
 */
export const fiscalDocumentPrimaryBtnSx = {
...
export const fiscalDocumentGhostBtnSx = {
  borderRadius: radius.button, // ✅ permitido (botão)
  minHeight: 40,
  px: `${space[4]}px`,
  fontWeight: 800,
 ...
 * ROW ACTION ICONS
 */
export const fiscalDocumentActionIconSx = {
  width: 40,
  height: 40,
...
export const fiscalDocumentDangerIconSx = {
  ...fiscalDocumentActionIconSx,
  borderColor: `rgba(255, 66, 66, 0.35)`,
  '&:hover': {
    ...fiscalDocumentActionIconSx['&:hover'],
 ...
 */
export const erpListSx = fiscalDocumentListSx;
export const erpDatagridSx = fiscalDocumentDatagridSx;
export const erpDetailsSx = fiscalDocumentDetailsSx;
export const erpFormSx = fiscalDocumentFormSx;
