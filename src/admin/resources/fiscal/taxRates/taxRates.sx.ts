// src/admin/resources/fiscal/taxRates/taxRates.sx.ts
import { colors, radius, shadows, space, typography } from '../../../../design/tokens';

/**
 * ✅ TaxRates com estilos próprios (sem depender de exports globais do layout).
 * Regras do app:
 * - ❌ Sem radius em wrappers/layout (cards, containers, etc.)
 * - ✅ Radius só em inputs/botões/tabela
 * - Sem Stack spacing={space[...]}; usar gap em px no componente
 */

/**
 * LIST (ListPage)
 */
export const taxRateListSx = {
  '& .RaList-main': {
    width: '100%',
    minWidth: 0,
    paddingTop: 0,
 ...
 */
export const taxRateDatagridSx = {
  width: '100%',
  overflow: 'visible',
  background: 'transparent',
  boxShadow: 'none',
 ...
 * SEARCH (Filter)
 */
export const taxRateSearchWrapSx = {
 ...
 * BUTTONS (base)
 */
export const taxRatePrimaryBtnSx = {
...
export const taxRateGhostBtnSx = {
  borderRadius: radius.button, // ✅ permitido (botão)
  minHeight: 40,
  px: `${space[4]}px`,
  fontWeight: 800,
 ...
 * ROW ACTION ICONS
 */
export const taxRateActionIconSx = {
  width: 40,
  height: 40,
...
export const taxRateDangerIconSx = {
  ...taxRateActionIconSx,
  borderColor: `rgba(255, 66, 66, 0.35)`,
  '&:hover': {
    ...taxRateActionIconSx['&:hover'],
 ...
 */
export const erpListSx = taxRateListSx;
export const erpDatagridSx = taxRateDatagridSx;
export const erpDetailsSx = taxRateDetailsSx;
export const erpFormSx = taxRateFormSx;
