// src/admin/resources/sales/salesOrders/SalesOrderDelete.tsx
...
export const SalesOrderDelete = () => (
  <ErpDelete title="Excluir pedido de venda" sx={salesOrderListShellSx}>
    <Box sx={{ mx: 'auto', width: '100%', maxWidth: 1040 }}>
      ...
      <Alert severity="warning" sx={{ mb: `${space[2]}px` }}>
        Esta ação é <b>permanente</b>. Se você precisa manter histórico comercial, considere
        alterar o <b>status</b> para <b>Cancelado</b> em vez de excluir.
      </Alert>
