// src/admin/resources/sales/salesOrders/salesOrders.sx.ts
import { colors, radius, shadows, typography } from '../../../../design/tokens';

export const salesOrderListShellSx = {
...
export const salesOrderDatagridSx = {
...
export const salesOrderSearchWrapSx = {
  width: { xs: '100%', sm: 320 },
...
export const salesOrderPrimaryBtnSx = {
...
export const salesOrderGhostBtnSx = {
  borderRadius: radius.button,
  fontFamily: typography.fontFamily,
...
export const salesOrderDetailsTypographySx = {
  '& .MuiTypography-root': {
    color: colors.text.secondary,
    fontFamily: typography.fontFamily,
  },
