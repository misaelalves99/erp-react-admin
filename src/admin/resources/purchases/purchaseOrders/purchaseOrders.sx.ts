// src/admin/resources/purchases/purchaseOrders/purchaseOrders.sx.ts
import { colors, radius, shadows, space, typography } from '../../../../design/tokens';

/**
 * ✅ Purchase Orders com estilos próprios (sem depender de exports globais).
 * Regras do app:
 ...
 */
export const purchaseOrderListSx = {
  '& .RaList-main': {
    width: '100%',
    minWidth: 0,
    paddingTop: 0,
 ...
 */
export const purchaseOrderDatagridSx = {
  width: '100%',
  overflow: 'visible',
  background: 'transparent',
  boxShadow: 'none',
 ...
 */
export const purchaseOrderDetailsSx = {
 ...
 */
export const purchaseOrderFormSx = {
  borderRadius: 0,
  background: 'transparent',
  boxShadow: 'none',
  border: 'none',
 ...
 */
export const purchaseOrderSearchWrapSx = {
 ...
 * HEADER PILL BUTTONS
 */
export const purchaseOrderPillBtnSx = {
 ...
 * BUTTONS (base)
 */
export const purchaseOrderPrimaryBtnSx = {
...
export const purchaseOrderGhostBtnSx = {
  borderRadius: radius.button, // ✅ permitido (botão)
  minHeight: 40,
  px: `${space[4]}px`,
  fontWeight: 800,
 ...
 * ROW ACTION ICONS
 */
export const purchaseOrderActionIconSx = {
  width: 40,
  height: 40,
...
export const purchaseOrderDangerIconSx = {
  ...purchaseOrderActionIconSx,
  borderColor: `rgba(255, 66, 66, 0.35)`,
  '&:hover': {
    ...purchaseOrderActionIconSx['&:hover'],
 ...
 */
export const erpListSx = purchaseOrderListSx;
export const erpDatagridSx = purchaseOrderDatagridSx;
export const erpDetailsSx = purchaseOrderDetailsSx;
export const erpFormSx = purchaseOrderFormSx;
