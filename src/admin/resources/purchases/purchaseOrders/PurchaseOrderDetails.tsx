// src/admin/resources/purchases/purchaseOrders/PurchaseOrderDetails.tsx
...
function ShowActions() {
  return (
    <TopToolbar>
      ...
      {/* Delete via rota custom /purchaseOrders/:id/delete (ícone na list) */}
    </TopToolbar>
  );
}

export const PurchaseOrderDetails = () => (
  <Show title="Pedido de compra" actions={<ShowActions />} sx={erpListSx}>
    <Box sx={{ mt: `${space[2]}px`, mx: 'auto', width: '100%', maxWidth: 1040 }}>
      ...
      <Box sx={{ mb: `${space[3]}px` }}>
        ...
        <Typography sx={{ mt: '4px', color: colors.text.muted, fontSize: 13 }}>
          Visualize fornecedor, status, data de criação e valores do pedido.
        </Typography>
      </Box>
            ...
            <SectionCard title="Status">
              <Stack sx={{ gap: 16 }}>
                ...
                <Box sx={{ color: colors.text.muted, fontSize: 13, lineHeight: 1.6 }}>
                  Marque como <b>Recebido</b> quando a mercadoria for conferida/entrada.
                </Box>
              </Stack>
            </SectionCard>
