// src/admin/resources/purchases/purchaseOrders/PurchaseOrderCreate.tsx
...
export const PurchaseOrderCreate = () => (
  <Create title="Novo pedido de compra" actions={<CreateActions />} redirect="list" sx={erpListSx}>
    <Box sx={{ mt: `${space[2]}px`, mx: 'auto', width: '100%', maxWidth: 1040 }}>
      ...
      <Box sx={{ mb: `${space[3]}px` }}>
        ...
        <Typography sx={{ mt: '4px', color: colors.text.muted, fontSize: 13 }}>
          Vincule um fornecedor, defina status e revise os valores antes de salvar.
        </Typography>
      </Box>
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={8}>
            <Stack sx={{ gap: 16 }}>
              ...
              <SectionCard title="Datas e valores">
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <TextInput
                      ...
                      multiline
                      minRows={3}
                      helperText="Notas internas do pedido de compra."
                    />
                  </Grid>
                </Grid>
              </SectionCard>
          ...
          <Grid item xs={12} md={4}>
            <Stack sx={{ gap: 16 }}>
              <SectionCard title="Status e controle">
                <Stack sx={{ gap: 16 }}>
                  ...
                  <Box sx={{ color: colors.text.muted, fontSize: 13, lineHeight: 1.6 }}>
                    • <b>Aprovado</b>: pronto para recebimento. <br />
                    • <b>Recebido</b>: atualize estoque se aplicável. <br />
                    • <b>Cancelado</b>: impede novas ações.
                  </Box>
                </Stack>
              </SectionCard>
              ...
              <SectionCard title="Dica">
                <Box sx={{ color: colors.text.muted, fontSize: 13, lineHeight: 1.6 }}>
                  Se o total for fechado depois, salve como <b>Em aberto</b> e ajuste ao finalizar o pedido.
                </Box>
              </SectionCard>
            </Stack>
          </Grid>
