// src/admin/resources/purchases/purchaseBills/purchaseBills.sx.ts
import { colors, radius, shadows, space, typography } from '../../../../design/tokens';

/**
 * ✅ Purchase Bills com estilos próprios (sem depender de exports globais).
 * Regras do app:
 ...
 */
export const purchaseBillListSx = {
  '& .RaList-main': {
    width: '100%',
    minWidth: 0,
    paddingTop: 0,
  ...
  // ✅ algumas telas usam Paper/Card por baixo
  '& .MuiPaper-root': {
    borderRadius: 0,
  },
} as const;
 ...
 */
export const purchaseBillDatagridSx = {
  width: '100%',
  overflow: 'visible',
  background: 'transparent',
  boxShadow: 'none',
 ...
 */
export const purchaseBillDetailsSx = {
 ...
 */
export const purchaseBillFormSx = {
  borderRadius: 0,
  background: 'transparent',
  boxShadow: 'none',
  border: 'none',
 ...
 */
export const purchaseBillSearchWrapSx = {
 ...
 * HEADER PILL BUTTONS
 */
export const purchaseBillPillBtnSx = {
 ...
 * BUTTONS (base)
 */
export const purchaseBillPrimaryBtnSx = {
...
export const purchaseBillGhostBtnSx = {
  borderRadius: radius.button, // ✅ permitido (botão)
  minHeight: 40,
  px: `${space[4]}px`,
  fontWeight: 800,
 ...
 * ROW ACTION ICONS
 */
export const purchaseBillActionIconSx = {
  width: 40,
  height: 40,
...
export const purchaseBillDangerIconSx = {
  ...purchaseBillActionIconSx,
  borderColor: `rgba(255, 66, 66, 0.35)`,
  '&:hover': {
    ...purchaseBillActionIconSx['&:hover'],
 ...
 */
export const erpListSx = purchaseBillListSx;
export const erpDatagridSx = purchaseBillDatagridSx;
export const erpDetailsSx = purchaseBillDetailsSx;
export const erpFormSx = purchaseBillFormSx;
