// src/admin/resources/purchases/suppliers/suppliers.sx.ts
import { colors, radius, shadows, space, typography } from '../../../../design/tokens';

/**
 * ✅ Suppliers com estilos próprios (sem depender de exports globais).
 * Regras do app:
 * - ❌ Sem radius em wrappers/layout (cards, containers, etc.)
 * - ✅ Radius só em inputs/botões/tabela (datatable/table wrapper)
 */

/**
 * LIST (List/Show/Edit/Create/Delete)
 * - remove “card wrapper” padrão do RA List (sem radius em layout)
 */
export const supplierListSx = {
  '& .RaList-main': {
    width: '100%',
    minWidth: 0,
    paddingTop: 0,
  ...
  // ✅ evita card do RA criar “layout com radius”
  ...
  // ✅ em algumas telas RA usa Paper/Card internamente
  '& .MuiPaper-root': {
    borderRadius: 0,
  },
} as const;
 ...
 */
export const supplierDatagridSx = {
  width: '100%',
  overflow: 'visible',
  background: 'transparent',
  boxShadow: 'none',
 ...
 */
export const supplierDetailsSx = {
 ...
 */
export const supplierFormSx = {
  // wrapper do form (layout) sem radius
  borderRadius: 0,
  background: 'transparent',
  boxShadow: 'none',
  border: 'none',
  ...
  // evita Paper interno criando radius em layout
  '& .MuiPaper-root': {
    borderRadius: 0,
  },
} as const;
 ...
 */
export const supplierSearchWrapSx = {
 ...
 * HEADER PILL BUTTONS
 */
export const supplierPillBtnSx = {
 ...
 * BUTTONS (base)
 */
export const supplierPrimaryBtnSx = {
...
export const supplierGhostBtnSx = {
  borderRadius: radius.button, // ✅ permitido (botão)
  minHeight: 40,
  px: `${space[4]}px`,
  fontWeight: 800,
 ...
 * ROW ACTION ICONS
 */
export const supplierActionIconSx = {
  width: 40,
  height: 40,
  borderRadius: radius.pill, // ✅ permitido (botão/ícone)
  border: `1px solid ${colors.border.default}`,
  backgroundColor: colors.glass.panel,
  boxShadow: shadows.soft,
  backdropFilter: colors.glass.blur,
...
export const supplierDangerIconSx = {
  ...supplierActionIconSx,
  borderColor: `rgba(255, 66, 66, 0.35)`,
  '&:hover': {
    ...supplierActionIconSx['&:hover'],
 ...
 * (agora são locais do módulo Suppliers, não globais)
 */
export const erpListSx = supplierListSx;
export const erpDatagridSx = supplierDatagridSx;
export const erpDetailsSx = supplierDetailsSx;
export const erpFormSx = supplierFormSx;
